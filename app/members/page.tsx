...
const data = {
  conrents: [
    ...
    },
    {
      ...
      position: "CTO",
      profile:
        "先進技術の研究開発と製品のイノベーションの分野で優れた経験を持つテクノロジーエキスパート。以前は大手テクノロジー企業の研究開発部門で主任エンジニアとして勤務し、革新的な製品の開発に携わった。最新の技術トレンドに精通し、当社の製品ポートフォリオを革新的かつ競争力のあるものにするためにリサーチと開発をリードしている。",
    },
  ],
};
...
export default function Page() {
  return (
    <div className={styles.container}>
      {data.conrents.length === 0 ? (
        <p className={styles.empty}>メンバーが登録されていません。</p>
      ) : (
        <ul>
          {data.conrents.map((member) => (
